...
import 'package:in307blog/unterricht/unterricht2023theming_navigation/screens/blog/blog_new_page.dart';
import 'package:in307blog/unterricht/unterricht2023theming_navigation/screens/home_page.dart';
    ...
    var mainArea = ColoredBox(
      ...
      child: AnimatedSwitcher(
        ...
        child: WillPopScope(
          ...
          // },
          onWillPop: () async =>
              !await selectedMenuItem.navigatorKey.currentState!.maybePop(),
          child: Navigator(
            key: selectedMenuItem.navigatorKey,
            onGenerateRoute: (settings) => MaterialPageRoute(
              builder: (context) => selectedMenuItem.page,
            ),
          ),
        ),
      ),
            ...
            return Row(
              children: [
                NavigationRail(
                  ...
                  destinations: MainMenuItem.items
                      .map((m) => NavigationRailDestination(
                          icon: Icon(m.icon), label: Text(m.text)))
                      .toList(),
